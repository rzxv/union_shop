...
class AboutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final contentPadding = const EdgeInsets.symmetric(horizontal: 20.0, vertical: 24.0);
    return Scaffold(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('What we do', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 8),
                      Text(
                      ...
                      const SizedBox(height: 18),
                      const Text('Contact & Opening Hours', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
                      const SizedBox(height: 8),
                      Text(
