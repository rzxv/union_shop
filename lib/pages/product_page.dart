...
class _ProductPageState extends State<ProductPage> {
  ...
  void _addToCart() {
    // If this is a media product (CD / Vinyl) we don't store size or color
    // in the cart — these attributes don't apply.
