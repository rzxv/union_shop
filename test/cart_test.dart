...
void main() {
  group('Cart model', () {
    ...
    test('adding items increases totalItems and stores item', () {
      ...
      globalCart.add(CartItem(id: 'p1', title: 'Product 1', color: 'Black', size: 'M'));
      ...
      globalCart.add(CartItem(id: 'p1', title: 'Product 1', color: 'Purple', size: 'M', quantity: 2));
      expect(globalCart.totalItems, 4);
      expect(globalCart.items.length, 2);
    });

    test('updateQuantity and remove work', () {
      globalCart.add(CartItem(id: 'p2', title: 'A', color: 'Grey', size: 'S', quantity: 3));
